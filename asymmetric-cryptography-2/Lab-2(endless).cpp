...
class RSA
{
    ...
    public:
        ...
        RSA(ZZ public_exponents, ZZ moduls)
        {            
            keys_public.e=public_exponents;                    keys_public.n=moduls;
        };

        RSA(ZZ encrypt_key,ZZ encrypt_signature,ZZ exponents, ZZ moduls)
        {            
            keys_public.e=exponents;                    keys_public.n=moduls;
            message_encrypt=encrypt_key;                signature_encrypt=encrypt_signature;
        };

        RSA (ZZ key,ZZ signature,ZZ key_one, ZZ key_two, ZZ e_, ZZ d_)
        {
            message_encrypt=key;                 signature_encrypt=signature;       
        ...
        void _rsa_send_message(ZZ exponent,ZZ module_receiver, RSA &abonent_send,RSA &abonent_receive);
...
void RSA::rsa_send_message(RSA &abonent_send,RSA &abonent_receive)
{
    ...
    cout<<endl<<"-key encrypt: "<<dec_to_hex(abonent_receive.message_encrypt)<<endl;
...
void total_commander()
{
    cout<<endl<<"Command in use:"<<endl;
        ...
        cout<<endl<<"\t[3] - digital signature;"<<endl;

        cout<<endl<<"\t[4] - check digital signature;"<<endl;

        cout<<endl<<"\t[5] - send key;"<<endl;

        cout<<endl<<"\t[6] - receive key;"<<endl;
    ...
    do
    {
        ...
        switch (answer)
        {
            ...
            case 1:
            {
                ...
                string hex_exponents; cin>>hex_exponents; ZZ exponents=hex_to_dec(hex_exponents); 
                ...
                ZZ cryptogram=User.rsa_encryption(message,exponents,moduls);
            ...
            case 2:
            {
                ...
                cout<<endl<<"-secrete keys \n"<<dec_to_hex(d)<<endl;

                cout<<endl<<"-exponents \n"<<dec_to_hex(e)<<endl;

                cout<<endl<<"-moduls \n"<<dec_to_hex(key_one_first*key_one_second)<<endl;

                cout<<endl<<"-cryptogram:"<<endl; 
                ...
                cout<<endl<<dec_to_hex(User.rsa_decryption(cryptogram,d,key_one_first*key_one_second))<<endl;
            ...
            case 3:
            {
                ...
                ZZ signature=User.rsa_digital_signature(message,d,key_one_first*key_one_second);
            ...
            case 4:
            {
                ...
                cout<<endl<<dec_to_hex(User.rsa_cheak_digital_signature(signature,exponents,moduls,message))<<endl;
            ...
            case 5:
            {
                ...
                generation_public_and_private_keys(key_one_first, key_one_second, key_two_first, key_two_second,e, d, e_, d_);
                 ...
                 cout<<endl<<"Input other for send key:"<<endl;
                ...
                ZZ key=find_prime_number_fixes_size(255);
                
                cout<<endl<<dec_to_hex(key)<<endl; 

                RSA Alise(key,key_one_first, key_one_second, e, d);     RSA Bob(exponents,moduls); 

                Alise.rsa_send_message(Alise,Bob);                      
            ...
            case 6:
            {
                ...
                cout<<endl<<"Input other for receive key:"<<endl;
                ...
                cout<<endl<<"-key_encrypt:"<<endl; 

                string hex_key; cin>>hex_key; ZZ key=hex_to_dec(hex_key); 

                cout<<endl<<"-signature_encrypt:"<<endl; 

                string hex_signature; cin>>hex_signature; ZZ signature=hex_to_dec(hex_signature); 


                RSA Alise(exponents,moduls);     RSA Bob(key,signature,key_two_first, key_two_second, e_,d_); 

                Bob.rsa_receive_message(Alise,Bob);    
